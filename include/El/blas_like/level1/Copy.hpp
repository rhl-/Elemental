...
inline void Copy( const Graph& A, Graph& B )
{
...
inline void Copy( const Graph& A, DistGraph& B )
{
...
inline void Copy( const DistGraph& A, Graph& B )
{
...
inline void Copy( const DistGraph& A, DistGraph& B )
{
...
inline void CopyFromRoot( const DistGraph& distGraph, Graph& graph )
{
...
inline void CopyFromNonRoot( const DistGraph& distGraph, int root )
{
