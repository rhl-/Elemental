#ifndef EL_BLAS_LIKE_LEVEL3_TRSM_HPP
#define EL_BLAS_LIKE_LEVEL3_TRSM_HPP
...
#define PROTO(F) \
  ...
  ( LeftOrRight side, \
    ...
    bool checkIfSingular, \
    TrsmAlgorithm alg ); \
  EL_EXTERN template void LocalTrsm \
  ( LeftOrRight side, \
    UpperOrLower uplo, \
    Orientation orientation, \
    UnitOrNonUnit diag, \
...
#endif /* EL_BLAS_LIKE_LEVEL3_TRSM_HPP */
